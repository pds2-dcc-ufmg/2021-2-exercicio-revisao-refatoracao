...
int main()
{
    ...
    venda2.setEsp(especialista2);
    venda2.setDescricao("Troca da tela do telefone");
    venda2.setValor(100);
    comissao02 += especialista2.comissao(venda2.getValor());
    numAtendimentos02+=1;


    Venda venda3;
    venda3.setCliente("Norman Osborn");
    venda3.setEsp(especialista1);
    ...
    venda8.setEsp(especialista2);
    venda8.setDescricao("Formatacao do PC");
    venda8.setValor(80);
    comissao02 += especialista2.comissao(venda8.getValor());
    numAtendimentos02+=1;
    ...
    gerente1.setBonificacao(gerente1.calculaBonificacaoGerente(NUMTOTALservicos));
    gerente1.print();
