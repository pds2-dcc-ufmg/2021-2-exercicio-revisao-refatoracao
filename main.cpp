...
int main()
{
    ...
    cout << "  Num Atendimentos: " << numAtendimentos01 << endl
         << "  Salario Total: " << e01.salarioBase+comissao01 << endl << endl;

    e02.print();
    cout << "  Num Atendimentos: " << numAtendimentos02 << endl
         << "  Salario Total: " << e02.salarioBase+comissao02 << endl << endl;

    e03.print();
    cout << "  Num Atendimentos: " << numAtendimentos03 << endl
         << "  Salario Total: " << e03.salarioBase+comissao03 << endl << endl;


    int numTotalServicos = 0;
    numTotalServicos = numAtendimentos01 + numAtendimentos02 + numAtendimentos03;
    g01.print();
    cout << "  Salario Total: " << g01.salarioBase + g01.calculaBonificacaoGerente(numTotalServicos) << endl << endl;
