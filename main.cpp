...
// O foco principal nesse código foi ajustar as varáveis para um mesmo padrão minusculas e com underline
// Além disso, foi ajustado o espaçamento e alguns usos de "\n", que podiam ser trocados por endl
