...
int main()
{
    ...
    v01.print();
    cout << " Descrição: " << v01._descricao << endl;

    v02.print();
    cout << " Descrição: " << v02._descricao << endl;

    v03.print();
    cout << " Descrição: " << v03._descricao << endl;

    v04.print();
    cout << " Descrição: " << v04._descricao << endl;

    v05.print();
    cout << " Descrição: " << v05._descricao << endl;

    v06.print();
    cout << " Descrição: " << v06._descricao << endl;

    v06.print();
    cout << " Descrição: " << v06._descricao << endl;

    v07.print();
    cout << " Descrição: " << v07._descricao << endl;

    v08.print();
    cout << " Descrição: " << v08._descricao << endl;
    ...
    g01._bonificacao = g01.calcBonificacao(numTotalServicos);
    g01.print();
    cout << "Salario Total: " << g01._salarioBase + g01._bonificacao<<endl;
