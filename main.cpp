...
Especialista e01;
    ...
    v05.set_esp(e03);
    v05.set_descricao("Reconstrução de Prédio");
    v05.set_valor(10000);
    ...
    v06.set_esp(e03);
    v06.set_descricao("Decoração de Apartamento no Brooklyn");
    v06.set_valor(3000);
    ...
    v07.set_esp(e03);
    v07.set_descricao("Reforma do Clarim Diário");
    v07.set_valor(5000);
    ...
    v08.set_esp(e02);
    v08.set_descricao("Formatação do PC");
    v08.set_valor(80);
