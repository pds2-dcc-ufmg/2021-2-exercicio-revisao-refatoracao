...
int main()
{
    ...
    std::vector<Venda> vendas = {v01, v02, v03, v04, v05, v06, v07, v08};
    std::cout << "\n\n           Relatorio das Vendas \n" << std::endl;
    for (Venda& venda : vendas) {
        venda.print();
    }

    int numTotalDeServicos = 0;
    std::vector<Especialista> especialistas = {e01, e02, e03};
    std::cout <<" \n \n           Relatorio dos Funcionarios \n" << std::endl;
    for (Especialista& especialista : especialistas) {
        int numAtendimentos = especialista.getAtendimentos();
        ...
        numTotalDeServicos += numAtendimentos;

    }

    g01.setBonificacao(g01.calcularBonificacao(numTotalDeServicos));
    g01.print();
