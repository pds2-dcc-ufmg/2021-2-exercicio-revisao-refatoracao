...
${BUILD_DIR}/${TARGET}: ${BUILD_DIR}/Cliente.o ${BUILD_DIR}/Especialista.o ${BUILD_DIR}/Gerente.o ${BUILD_DIR}/Venda.o ${BUILD_DIR}/FerramentaADM.o ${BUILD_DIR}/main.o
...
${BUILD_DIR}/FerramentaADM.o: ${INCLUDE_DIR}/FerramentaADM.hpp ${SRC_DIR}/FerramentaADM.cpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR} -c ${SRC_DIR}/FerramentaADM.cpp -o ${BUILD_DIR}/FerramentaADM.o

${BUILD_DIR}/main.o: ${INCLUDE_DIR}/Cliente.hpp ${INCLUDE_DIR}/Funcionario.hpp ${INCLUDE_DIR}/Especialista.hpp ${INCLUDE_DIR}/Gerente.hpp ${INCLUDE_DIR}/Venda.hpp ${INCLUDE_DIR}/FerramentaADM.hpp ${SRC_DIR}/main.cpp
