...
int Funcionario::getRegistroFuncional(){
    return _RegistroFuncional;
}
...
int Funcionario::getNumeroDeAtendimentos(){
    return _NumeroDeAtendimentos;
}

double Funcionario::getComissao(){
    return _Comissao;
}

void Funcionario::setRegistroFuncional(int RegistroFuncional){
    this->_RegistroFuncional = RegistroFuncional;
}
...
void Funcionario::setNumeroDeAtendimentos(int NumeroDeAtendimentos){
    this->_NumeroDeAtendimentos = NumeroDeAtendimentos;
}

void Funcionario::setComissao(double Comissao){
    this->_Comissao = Comissao;
}
