...
int main()
{
    ...
    vendas.emplace_back(clientes[0], especialistas[0], gerente, "Fotos do Homem Aranha", 100.0);
    vendas.emplace_back(clientes[3], especialistas[1], gerente, "Troca da tela do telefone", 100.0);
    vendas.emplace_back(clientes[1], especialistas[0], gerente, "Fotos do novo planador", 150.0);
    vendas.emplace_back(clientes[0], especialistas[1], gerente, "Recarga de cartucho", 10.0);
    vendas.emplace_back(clientes[3], especialistas[2], gerente, "Reconstrucao de Predio", 10000.0);
    vendas.emplace_back(clientes[4], especialistas[2], gerente, "Decoracao de Apartamento no Brooklyn", 3000.0);
    vendas.emplace_back(clientes[0], especialistas[2], gerente, "Reforma do Clarim Diario", 5000.0);
    vendas.emplace_back(clientes[2], especialistas[1], gerente, "Formatacao do PC", 80.0);
