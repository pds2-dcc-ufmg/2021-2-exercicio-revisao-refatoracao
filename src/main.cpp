...
int main()
{
    ...
    {
        i->ImprimeDados();
        std::cout << "Num Atendimentos: " << i->getNumAtendimentos() << std::endl;
        std::cout << "Salario Total: " << i->getSalarioBase() + i->getComissao() << std::endl;
        TotalServicos += i->getNumAtendimentos();
    }

    g01.setComissao( g01.CalculaBonificacao(TotalServicos));
    g01.ImprimeDados();
    std::cout << "Salario Total: " << g01.getSalarioBase() + g01.getComissao() << std::endl;
